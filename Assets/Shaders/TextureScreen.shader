...
Shader "Shader Forge/TextureScreen" {
    ...
    SubShader {
        ...
        Pass {
            ...
            uniform sampler2D _ScreenTexture; uniform float4 _ScreenTexture_ST;
            struct VertexInput {
...
////// Emissive:
                ...
                float2 node_7363 = (i.screenPos.rg*0.5+0.5);
                float4 node_5756 = tex2D(_ScreenTexture,TRANSFORM_TEX(node_7363, _ScreenTexture));
                float3 node_544 = (_Diffuse_var.rgb*node_5756.rgb); // Diffuse Color
